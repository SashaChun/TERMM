...
const Header = () => {
    ...
    return (
        <>
            <header
                className="bg-[#2c2e94e0] flex flex-col xl:flex-row items-center py-10 px-5 xl:px-10 h-auto xl:h-[300px] relative text-center xl:text-left">
                <img
                    className="xl:w-[200px] w-[90%] xl:h-[40px] md:h-[200px] h-[100px] xl:absolute xl:left-10 my-4 xl:my-0"
                    src={Logo} alt="Logo"/>
